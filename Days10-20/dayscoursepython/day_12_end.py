...
obj = MessageUser()
obj.add_user("Justin", 123.32, email='dayscoursepython@gmail.com')
obj.add_user("jOhn", 94.23, email='dayscoursepython@gmail.com')
obj.add_user("Sean", 93.23, email='dayscoursepython@gmail.com')
obj.add_user("Emilee", 193.23, email='dayscoursepython@gmail.com')
obj.add_user("Marie", 13.23, email='dayscoursepython@gmail.com')
obj.get_details()
